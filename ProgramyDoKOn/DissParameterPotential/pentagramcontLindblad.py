...
plt.plot(Potentials,Evolution[0], linewidth = 2, label = "$c_{ij}=0$")
plt.plot(Potentials,Evolution[5],'y-',linewidth = 2,label = "$c_{ij}=0.5$")
plt.plot(Potentials,Evolution[10],'r-',linewidth = 2,label="$c_{ij}=1$")
plt.plot(Potentials,Evolution[15],'m-',linewidth=2,label="$c_{ij}=1.5$")
plt.plot(Potentials,Evolution[20],'g-',linewidth=2,label="$c_{ij}=2$")
