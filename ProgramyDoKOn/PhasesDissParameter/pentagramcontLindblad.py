...
C00 = C11 = C22 = C33 = C44 = C55 = C66 = C77 = C88 = C99 = 0.1

# off-diagonal part

C12 = C21 = 0.1

C01 = C02 = C03 = C04 = C05 = C06 = C07 = C08 = 0
C10 = C13 = C14 = C15 = C16 = C17 = C18 = 0
C20 = C23 = C24 = C25 = C26 = C27 = C28 = 0
C30 = C31 = C32 = C34 = C35 = C36 = C37 = C38 = 0
C40 = C41 = C42 = C43 = C45 = C46 = C47 = C48 = 0
C50 = C51 = C52 = C53 = C54 = C56 = C57 = C58 = 0
C60 = C61 = C62 = C63 = C64 = C65 = C67 = C68 = 0
C70 = C71 = C72 = C73 = C74 = C75 = C76 = C78 = 0
C80 = C81 = C82 = C83 = C84 = C85 = C86 = C87 = 0
...
for j in range(len(phases)):
	...
	for i in range(200):
		...
		DissipPar.append(C00)
		F = open("MathLinDiss.txt","r")
		HDISS = F.read()
		HDISS = eval(HDISS)
		DISS = np.transpose(HDISS)
...
plt.plot(DissipPar,Evolution[0], linewidth = 2, label = "$\phi=0$")
plt.plot(DissipPar,Evolution[1],'g-',linewidth = 2,label = "$\phi=\pi/6$")
plt.plot(DissipPar,Evolution[2],'r-',linewidth = 2,label="$\phi=\pi/4$")
plt.plot(DissipPar,Evolution[3],'m-',linewidth=2,label="$\phi=\pi/3$")
plt.plot(DissipPar,Evolution[4],'y-',linewidth=2,label="$\phi=\pi/2$")
plt.plot(DissipPar,Evolution[5],'b-',linewidth=2,label="$\phi=\pi$")
plt.plot(DissipPar,Evolution[6],'c-',linewidth=2,label="$\phi=3 \pi/2$")
#plt.axhline(y = -3, color = 'black', linewidth = 3, hold = None)
ax1 = plt.subplot()
ax1.set_xlabel('$c_{ij}$');
