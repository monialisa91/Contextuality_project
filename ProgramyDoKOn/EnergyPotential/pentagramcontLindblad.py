...
Enodwr = 1.0/(En)
VCC = 2 # charge-current potential
...
plt.plot(Potentials,Evolution[0], linewidth = 2, label = "$E= 1 \; keV$")
plt.plot(Potentials,Evolution[2],'g-',linewidth = 2,label = "$E=100 \; keV$")
plt.plot(Potentials,Evolution[3],'r-',linewidth = 2,label="$E=1\;MeV$")
plt.plot(Potentials,Evolution[5],'m-',linewidth= 2,label="$E=100\; MeV$")
