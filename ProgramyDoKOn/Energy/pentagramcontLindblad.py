...
plt.plot(Czas, Evolution[1], linewidth = 2, label = "$E=1\;keV$")
plt.plot(Czas,Evolution[3],'y-',linewidth = 2,label = "$E=100\;keV$")
plt.plot(Czas,Evolution[5],'r-',linewidth=2,label="$E=10\; MeV$")
plt.plot(Czas,Evolution[7],'m-',linewidth=2,label="$E=1\;GeV$")
