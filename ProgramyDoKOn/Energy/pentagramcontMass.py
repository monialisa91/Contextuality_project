...
for j in range(3,10):
	...
	Kinetic[0][0] = np.sqrt(En * En + m1)
	Kinetic[1][1] = np.sqrt(En * En +_m2)
	Kinetic[2][2] = np.sqrt(En * En +_m3)
...
#plt.plot(Times,Evolution[0], linewidth = 2, label = "$E=1$")
#plt.plot(Times,Evolution[1],'g-',linewidth = 2,label = "$E=4$")
#plt.plot(Times,Evolution[2],'r-',linewidth = 2,label = "$E=8$")
plt.plot(Times,Evolution[3],'m-',linewidth = 2,label = "$E=10^{4}$")
plt.plot(Times,Evolution[4],'y-',linewidth = 2,label = "$E=10^{5}$")
plt.plot(Times,Evolution[5],'b-',linewidth = 2,label = "$E=10^{6}$")
