...
#plt.plot(DissipPar,Evolution[0], linewidth = 2, label = "$E=1\; keV$")
plt.plot(DissipPar,Evolution[2],'g-',linewidth = 2,label = "$E=100\;keV$")
plt.plot(DissipPar,Evolution[3],'r-',linewidth = 2,label="$E=1\; MeV$")
plt.plot(DissipPar,Evolution[5],'m-',linewidth=2,label="$E=100\; MeV$")
plt.plot(DissipPar,Evolution[6],'y-',linewidth=2,label="$E=1\;GeV$")
